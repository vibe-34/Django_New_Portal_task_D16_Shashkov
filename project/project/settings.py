...
SECRET_KEY = 'django-insecure--!u4nr9coze9s_s+38kbpy^3v6+ifq$=cd*oglh*vz#$jv31xb'
...
INSTALLED_APPS = [
    ...
    'django.contrib.auth',  # поддержка авторизации, добавляет пользователей
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request',  # `allauth` обязательно нужен этот процессор, для регистрации через сторонние сайты
...
LOGIN_REDIRECT_URL = '/announcement/'  # После входа, нас перебросит на список всех объявлений
